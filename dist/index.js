 ...
 *
 * Generated on: 2025-08-31T06:52:57.471Z
 */
/**
 * SVG template for Circle suit (number 1).
 * Exact contents from 1-Circle-text.svg
 */
const SVG_CIRCLE_1 = "<?xml version='1.0' encoding='utf-8'?>\n<svg xmlns=\"http://www.w3.org/2000/svg\" id=\"Layer_2\" viewBox=\"0 0 75.46 105.22\"><defs><style>.cls-back{fill:#fff;stroke:#231f20;stroke-width:.46px;}.cls-2,.cls-3{fill:#640d0d;}.cls-3{font-family:ClarendonBT-Black, 'Clarendon Blk BT';font-size:12px;font-weight:800;}</style><style type=\"text/css\">/* ===== Shared Whot Card Styles (normalized) ===== */\n.card-number {\n  font-family: \"Inter\", \"Segoe UI\", Arial, sans-serif;\n  font-weight: 700;\n  fill: #640d0d;\n  line-height: 1;\n}\n/* Optional helpers you can use (not applied automatically) */\n.card-number--large { font-size: 72px; }\n.card-number--medium { font-size: 48px; }\n.card-number--small { font-size: 28px; }\n/* You may override fill per suit in your own CSS if desired:\n   .card--circle .card-number { fill: #0B84F3; }\n   .card--cross  .card-number { fill: #E4572E; }\n   .card--square .card-number { fill: #76B7B2; }\n   .card--triangle .card-number { fill: #F1CE63; }\n   .card--star .card-number { fill: #59A14F; }\n*/</style></defs><g id=\"Layer_1-2\"><path class=\"cls-back\" d=\"M6.18.23h63.1c3.29,0,5.95,2.67,5.95,5.95v92.86c0,3.29-2.67,5.95-5.95,5.95H6.18c-3.29,0-5.95-2.67-5.95-5.95V6.18C.23,2.89,2.89.23,6.18.23Z\" /><circle class=\"cls-2\" cx=\"37.73\" cy=\"52.61\" r=\"20.8\" /><text class=\"cls-3\" transform=\"translate(5.21 12.38)\"><tspan x=\"0\" y=\"0\" class=\"card-number\">1</tspan></text><circle class=\"cls-2\" cx=\"9.16\" cy=\"18.88\" r=\"5.06\" /><text class=\"cls-3\" transform=\"translate(70.21 92.94) rotate(-180)\"><tspan x=\"0\" y=\"0\" class=\"card-number\">1</tspan></text><circle class=\"cls-2\" cx=\"66.26\" cy=\"86.34\" r=\"5.06\" /></g></svg>";
/**
 * SVG template for Cross suit (number 1).
 * Exact contents from 1-Cross-text.svg
 */
const SVG_CROSS_1 = "<?xml version='1.0' encoding='utf-8'?>\n<svg xmlns=\"http://www.w3.org/2000/svg\" id=\"Layer_2\" viewBox=\"0 0 75.46 105.22\"><defs><style>.cls-back{fill:#fff;stroke:#231f20;stroke-width:.46px;}.cls-2,.cls-2,.cls-3{fill:#640d0d;}.cls-3{font-family:ClarendonBT-Black, 'Clarendon Blk BT';font-size:12px;font-weight:800;}</style><style type=\"text/css\">/* ===== Shared Whot Card Styles (normalized) ===== */\n.card-number {\n  font-family: \"Inter\", \"Segoe UI\", Arial, sans-serif;\n  font-weight: 700;\n  fill: #640d0d;\n  line-height: 1;\n}\n/* Optional helpers you can use (not applied automatically) */\n.card-number--large { font-size: 72px; }\n.card-number--medium { font-size: 48px; }\n.card-number--small { font-size: 28px; }\n/* You may override fill per suit in your own CSS if desired:\n   .card--circle .card-number { fill: #0B84F3; }\n   .card--cross  .card-number { fill: #E4572E; }\n   .card--square .card-number { fill: #76B7B2; }\n   .card--triangle .card-number { fill: #F1CE63; }\n   .card--star .card-number { fill: #59A14F; }\n*/</style></defs><g id=\"Layer_1-2\"><path class=\"cls-back\" d=\"M6.18.23h63.1c3.29,0,5.95,2.67,5.95,5.95v92.86c0,3.29-2.67,5.95-5.95,5.95H6.18c-3.29,0-5.95-2.67-5.95-5.95V6.18C.23,2.89,2.89.23,6.18.23Z\" /><text class=\"cls-3\" transform=\"translate(5.21 12.38)\"><tspan x=\"0\" y=\"0\" class=\"card-number\">1</tspan></text><text class=\"cls-3\" transform=\"translate(70.22 92.94) rotate(-180)\"><tspan x=\"0\" y=\"0\" class=\"card-number\">1</tspan></text><rect class=\"cls-2\" x=\"32.46\" y=\"31.81\" width=\"10.18\" height=\"41.53\" /><polygon class=\"cls-2\" points=\"32.64 57.71 32.64 73.38 42.82 73.38 42.82 57.71 42.82 57.7 58.5 57.7 58.5 47.52 42.82 47.52 42.82 47.51 42.82 31.84 32.64 31.84 32.64 47.51 32.64 47.52 16.96 47.52 16.96 57.7 32.64 57.7 32.64 57.71\" /><polygon class=\"cls-2\" points=\"7.91 20.13 7.91 23.94 10.39 23.94 10.39 20.13 10.39 20.13 14.2 20.13 14.2 17.66 10.39 17.66 10.39 17.66 10.39 13.84 7.91 13.84 7.91 17.66 7.91 17.66 4.1 17.66 4.1 20.13 7.91 20.13 7.91 20.13\" /><polygon class=\"cls-2\" points=\"65.02 87.68 65.02 91.5 67.5 91.5 67.5 87.68 67.5 87.68 71.32 87.68 71.32 85.2 67.5 85.2 67.5 85.19 67.5 81.38 65.02 81.38 65.02 85.19 65.02 85.2 61.2 85.2 61.2 87.68 65.02 87.68 65.02 87.68\" /></g></svg>";
/**
 * SVG template for Square suit (number 1).
 * Exact contents from 1-Square-text.svg
 */
const SVG_SQUARE_1 = "<?xml version='1.0' encoding='utf-8'?>\n<svg xmlns=\"http://www.w3.org/2000/svg\" id=\"Layer_2\" viewBox=\"0 0 75.46 105.22\"><defs><style>.cls-back{fill:#fff;stroke:#231f20;stroke-width:.46px;}.cls-2,.cls-3{fill:#640d0d;}.cls-3{font-family:ClarendonBT-Black, 'Clarendon Blk BT';font-size:12px;font-weight:800;}</style><style type=\"text/css\">/* ===== Shared Whot Card Styles (normalized) ===== */\n.card-number {\n  font-family: \"Inter\", \"Segoe UI\", Arial, sans-serif;\n  font-weight: 700;\n  fill: #640d0d;\n  line-height: 1;\n}\n/* Optional helpers you can use (not applied automatically) */\n.card-number--large { font-size: 72px; }\n.card-number--medium { font-size: 48px; }\n.card-number--small { font-size: 28px; }\n/* You may override fill per suit in your own CSS if desired:\n   .card--circle .card-number { fill: #0B84F3; }\n   .card--cross  .card-number { fill: #E4572E; }\n   .card--square .card-number { fill: #76B7B2; }\n   .card--triangle .card-number { fill: #F1CE63; }\n   .card--star .card-number { fill: #59A14F; }\n*/</style></defs><g id=\"Layer_1-2\"><path class=\"cls-back\" d=\"M6.18.23h63.1c3.29,0,5.95,2.67,5.95,5.95v92.86c0,3.29-2.67,5.95-5.95,5.95H6.18c-3.29,0-5.95-2.67-5.95-5.95V6.18C.23,2.89,2.89.23,6.18.23Z\" /><rect class=\"cls-2\" x=\"17\" y=\"31.88\" width=\"41.46\" height=\"41.46\" /><text class=\"cls-3\" transform=\"translate(5.21 12.38)\"><tspan x=\"0\" y=\"0\" class=\"card-number\">1</tspan></text><rect class=\"cls-2\" x=\"4.1\" y=\"13.82\" width=\"10.12\" height=\"10.12\" /><text class=\"cls-3\" transform=\"translate(70.22 92.94) rotate(-180)\"><tspan x=\"0\" y=\"0\" class=\"card-number\">1</tspan></text><rect class=\"cls-2\" x=\"61.2\" y=\"81.38\" width=\"10.12\" height=\"10.12\" transform=\"translate(132.52 172.88) rotate(180)\" /></g></svg>";
/**
 * SVG template for Triangle suit (number 1).
 * Exact contents from 1-Triangle-text.svg
 */
const SVG_TRIANGLE_1 = "<?xml version='1.0' encoding='utf-8'?>\n<svg xmlns=\"http://www.w3.org/2000/svg\" id=\"Layer_2\" viewBox=\"0 0 75.46 105.22\"><defs><style>.cls-back{fill:#fff;stroke:#231f20;stroke-width:.46px;}.cls-2,.cls-3{fill:#640d0d;}.cls-3{font-family:ClarendonBT-Black, 'Clarendon Blk BT';font-size:12px;font-weight:800;}</style><style type=\"text/css\">/* ===== Shared Whot Card Styles (normalized) ===== */\n.card-number {\n  font-family: \"Inter\", \"Segoe UI\", Arial, sans-serif;\n  font-weight: 700;\n  fill: #640d0d;\n  line-height: 1;\n}\n/* Optional helpers you can use (not applied automatically) */\n.card-number--large { font-size: 72px; }\n.card-number--medium { font-size: 48px; }\n.card-number--small { font-size: 28px; }\n/* You may override fill per suit in your own CSS if desired:\n   .card--circle .card-number { fill: #0B84F3; }\n   .card--cross  .card-number { fill: #E4572E; }\n   .card--square .card-number { fill: #76B7B2; }\n   .card--triangle .card-number { fill: #F1CE63; }\n   .card--star .card-number { fill: #59A14F; }\n*/</style></defs><g id=\"Layer_1-2\"><path class=\"cls-back\" d=\"M6.18.23h63.1c3.29,0,5.95,2.67,5.95,5.95v92.86c0,3.29-2.67,5.95-5.95,5.95H6.18c-3.29,0-5.95-2.67-5.95-5.95V6.18C.23,2.89,2.89.23,6.18.23Z\" /><polygon class=\"cls-2\" points=\"37.73 31.86 13.77 73.36 61.69 73.36 37.73 31.86\" /><text class=\"cls-3\" transform=\"translate(5.21 12.38)\"><tspan x=\"0\" y=\"0\" class=\"card-number\">1</tspan></text><polygon class=\"cls-2\" points=\"9.16 13.59 3.18 23.94 15.14 23.94 9.16 13.59\" /><text class=\"cls-3\" transform=\"translate(70.22 92.84) rotate(-180)\"><tspan x=\"0\" y=\"0\" class=\"card-number\">1</tspan></text><polygon class=\"cls-2\" points=\"66.26 91.64 72.24 81.28 60.28 81.28 66.26 91.64\" /></g></svg>";
/**
 * SVG template for Star suit (number 1).
 * Exact contents from 1-Start-text.svg
 */
const SVG_STAR_1 = "<?xml version='1.0' encoding='utf-8'?>\n<svg xmlns=\"http://www.w3.org/2000/svg\" id=\"Layer_2\" viewBox=\"0 0 75.46 105.22\"><defs><style>.cls-back{fill:#fff;stroke:#231f20;stroke-width:.46px;}.cls-2,.cls-3{fill:#640d0d;}.cls-3{font-family:ClarendonBT-Black, 'Clarendon Blk BT';font-size:12px;font-weight:800;}</style><style type=\"text/css\">/* ===== Shared Whot Card Styles (normalized) ===== */\n.card-number {\n  font-family: \"Inter\", \"Segoe UI\", Arial, sans-serif;\n  font-weight: 700;\n  fill: #640d0d;\n  line-height: 1;\n}\n/* Optional helpers you can use (not applied automatically) */\n.card-number--large { font-size: 72px; }\n.card-number--medium { font-size: 48px; }\n.card-number--small { font-size: 28px; }\n/* You may override fill per suit in your own CSS if desired:\n   .card--circle .card-number { fill: #0B84F3; }\n   .card--cross  .card-number { fill: #E4572E; }\n   .card--square .card-number { fill: #76B7B2; }\n   .card--triangle .card-number { fill: #F1CE63; }\n   .card--star .card-number { fill: #59A14F; }\n*/</style></defs><g id=\"Layer_1-2\"><path class=\"cls-back\" d=\"M6.18.23h63.1c3.29,0,5.95,2.67,5.95,5.95v92.86c0,3.29-2.67,5.95-5.95,5.95H6.18c-3.29,0-5.95-2.67-5.95-5.95V6.18C.23,2.89,2.89.23,6.18.23Z\" /><polygon class=\"cls-2\" points=\"46.77 56.01 51.93 71.87 38.43 62.07 24.94 71.87 30.09 56.01 16.6 46.21 33.28 46.21 38.43 30.35 43.59 46.21 60.27 46.21 46.77 56.01\" /><text class=\"cls-3\" transform=\"translate(5.21 12.38)\"><tspan x=\"0\" y=\"0\" class=\"card-number\">1</tspan></text><polygon class=\"cls-2\" points=\"11.33 20.07 12.57 23.9 9.31 21.53 6.06 23.9 7.3 20.07 4.04 17.7 8.07 17.7 9.31 13.87 10.56 17.7 14.58 17.7 11.33 20.07\" /><text class=\"cls-3\" transform=\"translate(70.36 92.79) rotate(-180)\"><tspan x=\"0\" y=\"0\" class=\"card-number\">1</tspan></text><polygon class=\"cls-2\" points=\"64.25 85.11 63 81.28 66.26 83.65 69.52 81.28 68.28 85.11 71.53 87.48 67.51 87.48 66.26 91.3 65.02 87.48 60.99 87.48 64.25 85.11\" /></g></svg>";
/**
 * SVG template for Whot suit (Whot card).
 * Exact contents from Whot-text.svg
 */
const SVG_WHOT_ = "<?xml version='1.0' encoding='utf-8'?>\n<svg xmlns=\"http://www.w3.org/2000/svg\" id=\"Layer_2\" viewBox=\"0 0 75.46 105.22\"><defs><style>.cls-none{fill:none;}.cls-back{fill:#fff;stroke:#231f20;stroke-width:.46px;}.cls-stroke{stroke:#631011;stroke-width:.25px;}.cls-stroke,.cls-2,.cls-3{fill:#640d0d;}.cls-3{font-family:ClarendonBT-Black, 'Clarendon Blk BT';font-size:12px;font-weight:800;}</style><style type=\"text/css\">/* ===== Shared Whot Card Styles (normalized) ===== */\n.card-number {\n  font-family: \"Inter\", \"Segoe UI\", Arial, sans-serif;\n  font-weight: 700;\n  fill: #640d0d;\n  line-height: 1;\n}\n/* Optional helpers you can use (not applied automatically) */\n.card-number--large { font-size: 72px; }\n.card-number--medium { font-size: 48px; }\n.card-number--small { font-size: 28px; }\n/* You may override fill per suit in your own CSS if desired:\n   .card--circle .card-number { fill: #0B84F3; }\n   .card--cross  .card-number { f